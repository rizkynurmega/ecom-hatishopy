...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
        ...
        <small class="text-muted float-end">Input Inforation</small>
        </div>
        <div class="card-body">
        <form action="{{route('storeproduct')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="product_name" name="product_name" placeholder="Item Name" />
            </div>
            </div>
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="price" name="price" placeholder="Item Price (Number Only)" />
            </div>
            </div>
            ...
            <div class="col-sm-10">
            <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Qty (Number Only)" />
            </div>
            </div>
